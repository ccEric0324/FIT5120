    ...
    <div class="box-wrap">
        ...
        <div class="box-row">
            ...
            <section class="box">
                ...
                <?php if ( ( $stats->is_free_trial() && ! $stats->has_next_plan() ) || $stats->app_exceeded || $stats->is_free() ): ?>
                    <a class="button button-primary button-baqend"
                       href="<?php echo baqend_admin_url( 'baqend_upgrade' ); ?>">
                        <span><?php _e( 'Upgrade Now', 'baqend' ) ?></span>
                    </a>
                <?php elseif ( $stats->is_limited() ): ?>
                    <a class="button" href="https://dashboard.baqend.com/app/<?php echo $app_name; ?>/checkout#limit"
                       target="_blank" rel="nofollow">
                        <span><?php _e( 'Increase Limit', 'baqend' ) ?></span>
                    </a>
                <?php endif; ?>
            </section>
        </div>
