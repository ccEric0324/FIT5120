...
<?php if ( ( $stats !== null && $stats->is_free_trial() && $stats->remaining_days <= 7 && ! $stats->has_next_plan() ) || $stats !== null && $stats->is_free() ): ?>
  <a href="admin.php?page=baqend_upgrade" class="button button-primary button-baqend">
