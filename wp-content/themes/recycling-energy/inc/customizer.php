...
function recycling_energy_customize_register( $wp_customize ) {
	...
	$wp_customize->add_control('recycling_energy_logo_max_height',array(
		'label'	=> esc_html__('Logo Width','recycling-energy'),
		'section'	=> 'title_tagline',
		'type'		=> 'number'
	));

	$wp_customize->add_setting( 'recycling_energy_logo_title', array(
		'default'           => true,
		'transport'         => 'refresh',
		'sanitize_callback' => 'recycling_energy_sanitize_checkbox',
	) );
	$wp_customize->add_control( new Recycling_Energy_Toggle_Control( $wp_customize, 'recycling_energy_logo_title', array(
		'label'       => esc_html__( 'Show Site Title', 'recycling-energy' ),
		'section'     => 'title_tagline',
		'type'        => 'toggle',
		'settings'    => 'recycling_energy_logo_title',
	) ) );

    $wp_customize->add_setting( 'recycling_energy_logo_text', array(
		'default'           => true,
		'transport'         => 'refresh',
		'sanitize_callback' => 'recycling_energy_sanitize_checkbox',
	) );
	$wp_customize->add_control( new Recycling_Energy_Toggle_Control( $wp_customize, 'recycling_energy_logo_text', array(
		'label'       => esc_html__( 'Show Site Tagline', 'recycling-energy' ),
		'section'     => 'title_tagline',
		'type'        => 'toggle',
	...
	$wp_customize->add_setting( 'recycling_energy_theme_loader', array(
		'default'           => false,
		'transport'         => 'refresh',
		'sanitize_callback' => 'recycling_energy_sanitize_checkbox',
	) );
	$wp_customize->add_control( new Recycling_Energy_Toggle_Control( $wp_customize, 'recycling_energy_theme_loader', array(
		'label'       => esc_html__( 'Show Site Loader', 'recycling-energy' ),
		'section'     => 'recycling_energy_theme_settings',
		'type'        => 'toggle',
		'settings'    => 'recycling_energy_theme_loader',
	) ) );

	$wp_customize->add_setting( 'recycling_energy_scroll_enable', array(
		'default'           => true,
		'transport'         => 'refresh',
		'sanitize_callback' => 'recycling_energy_sanitize_checkbox',
	) );
	$wp_customize->add_control( new Recycling_Energy_Toggle_Control( $wp_customize, 'recycling_energy_scroll_enable', array(
		'label'       => esc_html__( 'Show Scroll Top', 'recycling-energy' ),
		'section'     => 'recycling_energy_theme_settings',
		'type'        => 'toggle',
		'settings'    => 'recycling_energy_scroll_enable',
	) ) );

	$wp_customize->add_setting('recycling_energy_scroll_options',array(
        'default' => 'right_align',
        'sanitize_callback' => 'recycling_energy_sanitize_choices'
	));
	$wp_customize->add_control('recycling_energy_scroll_options',array(
        'type' => 'select',
        'label' => __('Scroll Top Alignment','recycling-energy'),
        'section' => 'recycling_energy_theme_settings',
        'choices' => array(
            'right_align' => __('Right Align','recycling-energy'),
            'center_align' => __('Center Align','recycling-energy'),
            'left_align' => __('Left Align','recycling-energy'),
        ),
	) );
	...
	$wp_customize->add_setting( 'recycling_energy_shop_page_sidebar', array(
		'default'           => true,
		'transport'         => 'refresh',
		'sanitize_callback' => 'recycling_energy_sanitize_checkbox',
	) );
	$wp_customize->add_control( new Recycling_Energy_Toggle_Control( $wp_customize, 'recycling_energy_shop_page_sidebar', array(
		'label'       => esc_html__( 'Show Shop Page Sidebar', 'recycling-energy' ),
		'section'     => 'recycling_energy_theme_settings',
		'type'        => 'toggle',
		'settings'    => 'recycling_energy_shop_page_sidebar',
	) ) );

	$wp_customize->add_setting( 'recycling_energy_wocommerce_single_page_sidebar', array(
		'default'           => true,
		'transport'         => 'refresh',
		'sanitize_callback' => 'recycling_energy_sanitize_checkbox',
	) );
	$wp_customize->add_control( new Recycling_Energy_Toggle_Control( $wp_customize, 'recycling_energy_wocommerce_single_page_sidebar', array(
		'label'       => esc_html__( 'Show Shop Page Sidebar', 'recycling-energy' ),
		'section'     => 'recycling_energy_theme_settings',
		'type'        => 'toggle',
		'settings'    => 'recycling_energy_wocommerce_single_page_sidebar',
	) ) );
    ...
    $wp_customize->add_control(new Recycling_Energy_Toggle_Control( $wp_customize, 'header_social_icon_enable', 
        array(
            'label' => esc_html__('Hide / Show Social Icon', 'recycling-energy'),
            'type' => 'toggle',
            'section' => 'recycling_energy_urls',
        )
    ));

    $wp_customize->add_setting('recycling_energy_facebook_icon',array(
		'default'	=> 'fab fa-facebook-f',
		'sanitize_callback'	=> 'sanitize_text_field'
	));	
	$wp_customize->add_control(new Recycling_Energy_Fontawesome_Icon_Chooser(
        $wp_customize,'recycling_energy_facebook_icon',array(
		'label'	=> __('Add Facebook Icon','recycling-energy'),
		'transport' => 'refresh',
		'section'	=> 'recycling_energy_urls',
		'setting'	=> 'recycling_energy_facebook_icon',
		'type'		=> 'icon'
	)));
	...
	$wp_customize->add_setting('recycling_energy_header_fb_target',
    array(
        'default' => true,
        'sanitize_callback' => 'recycling_energy_sanitize_checkbox',
    )
    );
    $wp_customize->add_control(new Recycling_Energy_Toggle_Control( $wp_customize, 'recycling_energy_header_fb_target', 
        array(
            'label' => esc_html__('Open link in a new tab', 'recycling-energy'),
            'type' => 'toggle',
            'section' => 'recycling_energy_urls',
        )
    ));  
	...
	$wp_customize->add_control(new Recycling_Energy_Fontawesome_Icon_Chooser(
		...
		'label'	=> __('Add Twitter Icon','recycling-energy'),
		'transport' => 'refresh',
		'section'	=> 'recycling_energy_urls',
	...
	$wp_customize->add_setting('recycling_energy_header_twt_target',
    array(
        'default' => true,
        'sanitize_callback' => 'recycling_energy_sanitize_checkbox',
    )
    );
    $wp_customize->add_control(new Recycling_Energy_Toggle_Control( $wp_customize, 'recycling_energy_header_twt_target', 
        array(
            'label' => esc_html__('Open link in a new tab', 'recycling-energy'),
            'type' => 'toggle',
            'section' => 'recycling_energy_urls',
	...
	$wp_customize->add_control(new Recycling_Energy_Fontawesome_Icon_Chooser(
		...
		'label'	=> __('Add Youtube Icon','recycling-energy'),
		'transport' => 'refresh',
		'section'	=> 'recycling_energy_urls',
	...
	$wp_customize->add_setting('recycling_energy_header_ut_target',
    array(
        'default' => true,
        'sanitize_callback' => 'recycling_energy_sanitize_checkbox',
    )
    );
    $wp_customize->add_control(new Recycling_Energy_Toggle_Control( $wp_customize, 'recycling_energy_header_ut_target', 
        array(
            'label' => esc_html__('Open link in a new tab', 'recycling-energy'),
            'type' => 'toggle',
            'section' => 'recycling_energy_urls',
	...
	$wp_customize->add_control(new Recycling_Energy_Fontawesome_Icon_Chooser(
		...
		'label'	=> __('Add Instagram Icon','recycling-energy'),
		'transport' => 'refresh',
		'section'	=> 'recycling_energy_urls',
	...
	$wp_customize->add_setting('recycling_energy_header_ins_target',
    array(
        'default' => true,
        'sanitize_callback' => 'recycling_energy_sanitize_checkbox',
    )
    );
    $wp_customize->add_control(new Recycling_Energy_Toggle_Control( $wp_customize, 'recycling_energy_header_ins_target', 
        array(
            'label' => esc_html__('Open link in a new tab', 'recycling-energy'),
            'type' => 'toggle',
            'section' => 'recycling_energy_urls',
	...
	$wp_customize->add_setting('recycling_energy_footer_widget',array(
			'default' => '4',
			'sanitize_callback' => 'recycling_energy_sanitize_select'
		));
	$wp_customize->add_control('recycling_energy_footer_widget',array(
		'label' => esc_html__('Footer Per Column','recycling-energy'),
		'section' => 'recycling_energy_footer_copyright',
		'setting' => 'recycling_energy_footer_widget',
		'type' => 'radio',
				'choices' => array(
						'1'   => __('1 Column', 'recycling-energy'),
						'2'  => __('2 Column', 'recycling-energy'),
						'3' => __('3 Column', 'recycling-energy'),
						'4' => __('4 Column', 'recycling-energy')
				),
	));
