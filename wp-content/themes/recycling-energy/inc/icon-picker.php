...
class Recycling_Energy_Fontawesome_Icon_Chooser extends WP_Customize_Control{
    public $type = 'icon';
        ...
        ?>
            <label>
                ...
                <div class="social-icon-search">
                    <input class="socialInput" type="text" placeholder="<?php echo esc_attr_x( 'Icon', 'placeholder', 'recycling-energy' ); ?>">
                </div>
                ...
                <ul class="icon-list clearfix">
                    <?php
                    $recycling_energy_font_awesome_icon_array = recycling_energy_font_awesome_icon_array();
                    foreach ($recycling_energy_font_awesome_icon_array as $recycling_energy_font_awesome_icon) {
                            $icon_class = $this->value() == $recycling_energy_font_awesome_icon ? 'icon-active' : '';
                            echo '<li class='.esc_attr($icon_class).'><i class="'.esc_attr($recycling_energy_font_awesome_icon).'"></i>
                            <span class="recycling-energy-social-class">'.esc_attr($recycling_energy_font_awesome_icon).'</span>
                            </li>';
                        }
                    ?>
                </ul>
...
function recycling_energy_customizer_script() {
     
    wp_enqueue_style( 'font-awesome-1', esc_url(get_template_directory_uri()).'/assets/css/fontawesome-all.css');
    wp_enqueue_script( 'recycling-energy-customizer-script', esc_url(get_template_directory_uri()).'/assets/js/customizer-scripts.js', array("jquery"),'', true  );
}
add_action( 'customize_controls_enqueue_scripts', 'recycling_energy_customizer_script' );

if(!function_exists('recycling_energy_font_awesome_icon_array')){
    function recycling_energy_font_awesome_icon_array(){
