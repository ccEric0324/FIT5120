...
function recycling_energy_guide() {
	...
	$recycling_energy_theme = wp_get_theme(); ?>

	<div class="getting-started__header">
		<div class="col-md-10">
			<h2><?php echo esc_html( $recycling_energy_theme ); ?></h2>
			<p><?php esc_html_e('Version: ', 'recycling-energy'); ?><?php echo esc_html($recycling_energy_theme['Version']);?></p>
		</div>
		<div class="col-md-2">
			<div class="btn_box">
