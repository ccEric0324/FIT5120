...
<?php $recycling_energy_post_option = get_theme_mod( 'recycling_energy_grid_column','3_column');
    if($recycling_energy_post_option == '1_column'){ ?>
    <div class="col-lg-12 col-md-12">
<?php }else if($recycling_energy_post_option == '2_column'){ ?>
    <div class="col-lg-6 col-md-6">
<?php }else if($recycling_energy_post_option == '3_column'){ ?>
    <div class="col-lg-4 col-md-4">
<?php }else if($recycling_energy_post_option == '4_column'){ ?>
    <div class="col-lg-3 col-md-3">
<?php }else if($recycling_energy_post_option == '5_column'){ ?>
