	    ...
	    <div class="post-main-box p-3 mb-3 wow bounceInDown delay-1000" data-wow-duration="2s">
	        ...
	        <div class="new-text">
	        	<div class="entry-content">
	        		<p>
			            <?php $vw_gardening_landscaping_excerpt = get_the_excerpt(); echo esc_html( vw_gardening_landscaping_string_limit_words( $vw_gardening_landscaping_excerpt, esc_attr(get_theme_mod('vw_gardening_landscaping_related_posts_excerpt_number','30')))); ?> <?php echo esc_html( get_theme_mod('vw_gardening_landscaping_excerpt_suffix','') ); ?>
			         </p>
	        	</div>
	        </div>
